...
class TripDetailScreen extends StatefulWidget {
  ...
  const TripDetailScreen({super.key, required this.id, required this.fac});
...
class _TripDetailScreenState extends State<TripDetailScreen> {
  ...
  bool isFacilitiesExpanded = false; // Track if facilities are expanded
  bool isRulesExpanded = false; // Track if facilities are expanded
