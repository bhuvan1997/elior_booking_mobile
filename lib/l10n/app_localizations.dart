...
//   ];
//
//   /// No description provided for @welcomeElior.
//   ///
//   /// In en, this message translates to:
//   /// **'Welcome to Elior 👋'**
//   String get welcomeElior;
//
...
//
//   /// Pluralized room count
//   ///
//   /// In en, this message translates to:
//   /// **'{count, plural, =0{No rooms} =1{1 room} other{{count} rooms}}'**
//   String nRooms(int count);
//
//   /// Gendered label for host/hostess
//   ///
//   /// In en, this message translates to:
//   /// **'{gender, select, male{Host} female{Hostess} other{Host}}'**
